...
let highierBMI = () => {
  if (
    (mosBMIinfo.Height / (mosBMIinfo.Mass * mosBMIinfo.Mass)) * 703 <
    (davidsBMIinfo.Height / (davidsBMIinfo.Mass * davidsBMIinfo.Mass)) * 703
  ) {
    console.log(davidsBMIinfo.FullName);
  } else {
    console.log(mosBMIinfo.FullName);
  }
};
